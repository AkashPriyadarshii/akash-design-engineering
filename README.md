...
[![Build: Slop-Free](https://img.shields.io/badge/Build-Slop--Free-success.svg?style=for-the-badge)](#)
[![Architecture: 4-Phase](https://img.shields.io/badge/Architecture-4--Phase-blue.svg?style=for-the-badge)](#)
[![Author: Akash Priyadarshi](https://img.shields.io/badge/Author-Akash_Priyadarshi-white.svg?style=for-the-badge)](https://github.com/AkashPriyadarshii)
...
```mermaid
graph TD
    A[User Prompt] --> B(Phase 1: Generative Routing)
    B --> C{OKLCH Math Gate}
    C -->|Fails Constraint| B
    C -->|Passes Constraint| D(Phase 2: Dual-Lane Break)
    
    D --> E[Seeded Planner: Follows Causal Anchor]
    D --> F[Unseeded Planner: Independent & Raw]
    
    E --> G[Fusion: Strict DESIGN.md Spec]
    F --> G
    
    G --> H(Phase 3: The Adversarial Gauntlet)
    H --> I{Slop Scanner & Atomic Checks}
    
    I -->|Emojis/Buzzwords Found| J[Phase 4: Escalation Ratchet]
    J --> H
    
    I -->|Clean & Strict| K((Final Production Output))
```
...
* **Semantic Rigidity:** The agent is forced to use strict semantic tags (`<data>`, `<samp>`, `<kbd>`, `<output>`) instead of nested `<div>` soup.
...
* **Fake Assets Banned:** NEVER build fake product UIs out of `<div>` rectangles. Must use real images with sophisticated CSS filters (`grayscale`, `mix-blend-luminosity`).
...
<div align="center">
  <br>
  <img src="https://img.shields.io/github/followers/AkashPriyadarshii?label=Follow&style=social" alt="GitHub followers">
  <br>
